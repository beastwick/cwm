...
#define FUNC_SC(t, h, n) \
	...
	{ FUNC_SC(group-toggle-10, group_toggle, 10) },
	{ FUNC_SC(group-toggle-11, group_toggle, 11) },
	{ FUNC_SC(group-toggle-12, group_toggle, 12) },
	{ FUNC_SC(group-toggle-13, group_toggle, 13) },
	{ FUNC_SC(group-toggle-14, group_toggle, 14) },
	{ FUNC_SC(group-toggle-15, group_toggle, 15) },
	{ FUNC_SC(group-toggle-16, group_toggle, 16) },
	{ FUNC_SC(group-toggle-17, group_toggle, 17) },
	{ FUNC_SC(group-toggle-18, group_toggle, 18) },
	{ FUNC_SC(group-toggle-19, group_toggle, 19) },
	{ FUNC_SC(group-toggle-20, group_toggle, 20) },
	{ FUNC_SC(group-toggle-21, group_toggle, 21) },
...
static const struct {
	...
	{ "CM-8",	"group-toggle-8" },
	{ "CM-9",	"group-toggle-9" },
	{ "M-F1",	"group-toggle-10" },
	{ "M-F2",	"group-toggle-11" },
	{ "M-F3",       "group-toggle-12" },
	{ "M-F4",       "group-toggle-13" },
	{ "M-F5",       "group-toggle-14" },
	{ "M-F6",       "group-toggle-15" },
	{ "M-F7",       "group-toggle-16" },
	{ "M-F8",       "group-toggle-17" },
	{ "M-F9",       "group-toggle-18" },
	{ "M-F10",      "group-toggle-19" },
	{ "M-F11",      "group-toggle-20" },
	{ "M-F12",      "group-toggle-21" },
	{ "M-Right",	"group-cycle" },
	{ "M-Left",	"group-rcycle" },
	{ "CM-g",	"window-group" },
